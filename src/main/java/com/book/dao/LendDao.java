...
public class LendDao {
    ...
    private final static String MY_LEND_LIST_SQL="SELECT * FROM lend_list WHERE reader_id = %s ";
    ...
    public ArrayList<Lend> lendList(){
        ...
        jdbcTemplate.query(new PreparedStatementCreator() {
            ...
            public PreparedStatement createPreparedStatement(Connection con) throws SQLException {
                return con.prepareStatement(LEND_LIST_SQL, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
            }
...
//        });
    ...
    public ArrayList<Lend> myLendList(int readerId){
        ...
        jdbcTemplate.query(new PreparedStatementCreator() {
            @Override
            public PreparedStatement createPreparedStatement(Connection con) throws SQLException {
                return con.prepareStatement(String.format(MY_LEND_LIST_SQL, readerId), ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
            }
        }, new RowCallbackHandler() {
            @Override
            public void processRow(ResultSet resultSet) throws SQLException {
