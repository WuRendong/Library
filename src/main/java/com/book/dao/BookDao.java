    ...
    public ArrayList<Book> queryBook(String sw){
        ...
        jdbcTemplate.query(new PreparedStatementCreator() {
            ...
            public PreparedStatement createPreparedStatement(Connection con) throws SQLException {
                return con.prepareStatement(QUERY_BOOK_SQL, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
            }
...
//        jdbcTemplate.query(String.format(QUERY_BOOK_SQL, swcx, swcx), new RowCallbackHandler() {
...
//        });
    ...
    public ArrayList<Book> getAllBooks(){
        ...
        jdbcTemplate.query(new PreparedStatementCreator() {
            @Override
            public PreparedStatement createPreparedStatement(Connection con) throws SQLException {
                return con.prepareStatement(QUERY_ALL_BOOKS_SQL, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
            }
